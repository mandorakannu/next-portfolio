...
function About() {
  return (
    <>
      <section
        className="bg-teal-500 flex flex-col justify-center items-center h-screen px-5 py-20 gap-10 text-white"
        id="about"
      ...
      >
        ...
        <p className="w-4/5 mx-auto text-lg">
          ...
          Dev Community. Feel free to Connect or Follow me on my Linkedin where
